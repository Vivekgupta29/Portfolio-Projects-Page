...
function Cards({ height, data }) {
    ...
    return (
        <div className={`w-full rounded-xl font-Nunito relative z-[999] text-white cursor-pointer`} style={{ height }} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <video
            ...
            <div className='absolute w-full h-[40%] bg-gradient-to-t from-slate-700 to-transparent bottom-0 left-0 rounded-b-xl'>
                <div className='absolute w-full flex items-center px-6 my-1 bottom-10 left-0'>
                    ...
                    <button className='bg-white text-black rounded-[50%] ml-2 w-5 h-5 flex items-center justify-center rotate-[45deg]' href=
                        {data.link}>
